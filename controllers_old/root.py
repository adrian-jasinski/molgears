...
class RootController(BaseController):
    """
    The root controller for the molgears application.
    ...
    def _before(self, *args, **kw):
        tmpl_context.project_name = "molgears"

    @expose('molgears.templates.index')
    def index(self):
        """Handle the front-page."""
        return dict(page='index')
    @expose('molgears.templates.about')
    def about(self):
        """Handle the 'about' page."""
        return dict(page='about')

    @expose('molgears.templates.environ')
    def environ(self):
        """This method showcases TG's access to the wsgi environment."""
        return dict(page='environ', environment=request.environ)

    @expose('molgears.templates.data')
    @expose('json')
    def data(self, **kw):
        """
